...
import { SimpleGrid, Box, Text, Image, Spinner, Stack, Link } from '@chakra-ui/react';
  ...
  return (
    <>
        <Stack direction="row" spacing={4}>
            ...
            />
            <Box>
                <Text as='b' fontSize='2xl'>{selectedProducer.name}</Text>
        ...
        <Link as={RouterLink} to={`/producers/${id}/cheeses/new`}>Add a cheese</Link>
    </>
  );
}
